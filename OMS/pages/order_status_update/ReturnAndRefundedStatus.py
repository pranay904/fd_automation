...
class ReturnAndRefundedStatus:
    ...
    def select(self):
        ...
        # Iterate through all options and select 'Return & Refunded' if it exists
        for i in range(options_count):
            ...
            if option_text == "Return & Refunded":
                options.nth(i).click()  # Click the 'Return & Refunded' option
                print("Selected 'Return & Refunded'")
                break  # Stop after selecting 'Return & Refunded'
        else:
            print("'Return & Refunded' option not found")
