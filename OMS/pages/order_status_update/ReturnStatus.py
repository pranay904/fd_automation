...
class ReturnStatus:
    ...
    def select(self):
        ...
        for i in range(options_count):
            ...
            if option_text == "Returned":
                options.nth(i).click()  # Click the 'Return option
                print("Selected 'Returned'")
                break  # Stop after selecting 'Return'
        else:
            print("'Returned ' option not found")
