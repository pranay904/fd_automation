...
class DeliveredStatus:
    ...
    def select(self):
        ...
        # Iterate through all options and select 'Delivered' if it exists
        for i in range(options_count):
            ...
            if option_text == "Delivered":
                options.nth(i).click()  # Click the 'Delivered' option
                print("Selected 'Delivered'")
                break  # Stop after selecting 'Delivered'
        else:
            print("'Delivered' option not found")
