...
class ShippedStatus:
    ...
    def select(self):
        ...
        # Iterate through all options and select 'Shipped' if it exists
        for i in range(options_count):
            ...
            if option_text == "Shipped":
                options.nth(i).click()  # Click the 'Shipped' option
                print("Selected 'Shipped'")
                break  # Stop after selecting 'Shipped'
        else:
            print("'Shipped' option not found")
