...
class CancelledRefundedStatus:
    ...
    def select(self):
        ...
        # Iterate through all options and select 'Cancelled & Refunded' if it exists
        for i in range(options_count):
            ...
            if option_text == "Cancelled & Refunded":
                options.nth(i).click()  # Click the 'Cancelled & Refunded' option
                print("Selected 'Cancelled & Refunded'")
                break  # Stop after selecting 'Cancelled & Refunded'
        else:
            print("'Cancelled & Refunded' option not found")
